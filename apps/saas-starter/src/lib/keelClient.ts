...
export class APIClient extends Core {
  ...
  private actions = {
    ...
    listUsers: (i?: ListUsersInput) => {
      return this.client.rawRequest<{ results: User[]; pageInfo: any }>(
        'listUsers',
        i
      );
    },
    ...
    listTeams: (i?: ListTeamsInput) => {
      return this.client.rawRequest<{ results: Team[]; pageInfo: any }>(
        'listTeams',
        i
      );
    },
    ...
    createTeam: (i: CreateTeamInput) => {
      return this.client.rawRequest<TeamMembership>('createTeam', i);
    },
    ...
    listDocuments: (i?: ListDocumentsInput) => {
      return this.client.rawRequest<{ results: Document[]; pageInfo: any }>(
        'listDocuments',
        i
      );
    },
    ...
    listImages: (i?: ListImagesInput) => {
      return this.client.rawRequest<{ results: ProfileImage[]; pageInfo: any }>(
        'listImages',
        i
      );
    },
    ...
    uploadImageToCloudinary: (i: UploadImageInput) => {
      return this.client.rawRequest<UploadImageResponse>(
        'uploadImageToCloudinary',
        i
      );
    },
    activeInvites: (i?: ActiveInvitesInput) => {
      return this.client.rawRequest<{ results: Invitation[]; pageInfo: any }>(
        'activeInvites',
        i
      );
    },
  ...
  api = {
    queries: {
      me: this.actions.me.bind(this),
      listUsers: this.actions.listUsers.bind(this),
      getTeam: this.actions.getTeam.bind(this),
      listTeams: this.actions.listTeams.bind(this),
      getDocument: this.actions.getDocument.bind(this),
      listDocuments: this.actions.listDocuments.bind(this),
      getImage: this.actions.getImage.bind(this),
      listImages: this.actions.listImages.bind(this),
      activeInvites: this.actions.activeInvites.bind(this),
    },
    mutations: {
      deleteUser: this.actions.deleteUser.bind(this),
      createUser: this.actions.createUser.bind(this),
      updateUser: this.actions.updateUser.bind(this),
      deleteTeam: this.actions.deleteTeam.bind(this),
      updateTeam: this.actions.updateTeam.bind(this),
      createTeam: this.actions.createTeam.bind(this),
      deleteDocument: this.actions.deleteDocument.bind(this),
      createDocument: this.actions.createDocument.bind(this),
      updateDocument: this.actions.updateDocument.bind(this),
      deleteImage: this.actions.deleteImage.bind(this),
      uploadImageToCloudinary: this.actions.uploadImageToCloudinary.bind(this),
      createInvite: this.actions.createInvite.bind(this),
...
export interface CreateTeamInput {
  team: CreateTeamTeamInput;
  user: CreateTeamUserInput;
}
export interface CreateTeamTeamInput {
  name: string;
  description: string | null;
}
...
export interface ListDocumentsUserInput {
  id?: IdQueryInput;
}
